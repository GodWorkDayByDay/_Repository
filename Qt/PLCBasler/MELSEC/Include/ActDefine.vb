...
Module ActDefine
    ...
    Public Const UNIT_LNETHER As Short = &H52S ' Ethernet(LCPU) IP
    ...
    Public Const UNIT_GOT_QJ71E71 As Short = &H40S ' GOT Transparent QJ71E71
    Public Const UNIT_GOT_QNETHER As Short = &H41S ' GOT Transparent Ethernet(QCPU)
    Public Const UNIT_GOT_LNETHER As Short = &H55S ' GOT Transparent Ethernet(LCPU)
    Public Const UNIT_GOT_NZ2GF_ETB As Short = &H5BS ' GOT Transparent NZ2GF-ETB
    Public Const UNIT_GOTETHER_QNCPU As Short = &H56S ' GOT Transparent ETHERNET-QCPU
    Public Const UNIT_GOTETHER_QBUS As Short = &H58S ' GOT Transparent ETHERNET-QBUS
    Public Const UNIT_GOTETHER_LNCPU As Short = &H57S ' GOT Transparent ETHERNET-LCPU
    ...
    Public Const UNIT_LJ71E71 As Short = &H5CS 				' Ethernet(LJ71E71)
    Public Const UNIT_GOT_LJ71E71 As Short = &H5DS 			' GOT Transparent LJ71E71
